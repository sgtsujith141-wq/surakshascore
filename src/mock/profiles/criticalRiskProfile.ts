...
/**
 * Profile containing multiple severe and critical vulnerabilities.
 */
export function createCriticalRiskProfile(timestamp: string = new Date().toISOString()): SignalMap {
  const signals: Record<string, Signal> = {
    ...
    'account.password_reuse': {
      ...
      tier: EvidenceTier.TIER_4_SELF_REPORTED,
      status: 'AVAILABLE',
      value: 'across_critical_services', // Critical Finding
      timestamp,
      source: 'assessment_survey',
    },
    ...
    'update.os_patch_age_days': {
      ...
      tier: EvidenceTier.TIER_2_OS_API,
      status: 'AVAILABLE',
      value: 365, // High Finding (>90 days)
      timestamp,
